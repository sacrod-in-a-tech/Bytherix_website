        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl lg:text-5xl">
              ...
              <p className="mx-auto max-w-8xl text-base leading-relaxed text-[var(--text-secondary)] sm:text-lg">
          ...
          >
            <p className="mb-3 text-[10px] uppercase tracking-widest text-[var(--text-muted)] sm:mb-4 sm:text-xs">
              The moment
            </p>
